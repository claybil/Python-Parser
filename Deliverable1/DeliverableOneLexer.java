...
public class DeliverableOneLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"T__9", "T__10", "T__11", "T__12", "T__13", "ID", "NUMBER", "INT", "FLOAT", 
			"STRING", "BOOLEAN", "CHAR", "ASSIGN", "WS"
		};
	}
	...
	public DeliverableOneLexer(CharStream input) {
		super(input);
