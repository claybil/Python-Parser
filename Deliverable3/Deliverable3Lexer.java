...
public class Deliverable3Lexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"IF", "ELSE_IF", "ELSE", "WHILE", "FOR", "LOGIC_NOT", "LOGIC_AND", "LOGIC_OR", 
			"BOOLEAN", "RANGE", "ID", "LITERAL", "CHAR", "ARRAY", "STRING", "NUMBER", 
			"INT", "FLOAT", "COMPOUND", "COMMENT", "INDENT", "WS", "NEWLINE", "LEFT_PARENTH", 
